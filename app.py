...
Original file is located at
    https://colab.research.google.com/drive/1h0k6CunZTI4T9d9E3OiyP3FiHbcEG_7R
"""
...
# FAISS index
faiss_index = faiss.read_index("my_index_cleaned.index")
...
def get_response(user_query, chat_history, privacy_mode=False, top_k=3, similarity_threshold=SIMILARITY_THRESHOLD):
    try:
        ...
        # For FAISS, clean AFTER redaction so placeholders persist
        ...
        if DEBUG_MODE:
            ...
            print(f"Top FAISS match: {matched_queries[0]}")
        ...
        if cosine_similarity >= similarity_threshold:
            ...
            debug_meta = f"[📚 FAISS | Sim: {round(cosine_similarity, 2)} | Intent: {gemini_intent}]"
